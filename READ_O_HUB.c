...
{
    struct book *ptr, *new_book1, *new_book2, *new_book3, *new_book4, *new_book5,*new_book6;

    new_book1 = (struct book *)malloc(sizeof(struct book));
    new_book1->next = NULL;
    start_lib = new_book1;
    strcpy(new_book1->name, "Murder On Orient Express");
    strcpy(new_book1->author, " Agatha Christie");
    new_book1->id = 101;
    ptr = new_book1;

    new_book2 = (struct book *)malloc(sizeof(struct book));
    new_book2->next = NULL;
    strcpy(new_book2->name, "Harry potter");
    strcpy(new_book2->author, " J.K. Rowling");
    new_book2->id = 102;
    ptr->next = new_book2;
    ptr = new_book2;
    ...
    new_book3->next = NULL;
    strcpy(new_book3->name, "The Hunger Games");
    strcpy(new_book3->author, " Suzanne Collins");
    new_book3->id = 103;
    ptr->next = new_book3;
    ptr = new_book3;
    ...
    new_book4->next = NULL;
    strcpy(new_book4->name, "A Passage to India");
    strcpy(new_book4->author, " E.M. Forster");
    new_book4->id = 104;
    ptr->next = new_book4;
    ptr = new_book4;
    ...
    new_book5->next = NULL;
    strcpy(new_book5->name, "It Ends With Us");
    strcpy(new_book5->author, " Coollen Hoover");
    new_book5->id = 105;
    ptr->next = new_book5;
    ptr = new_book5;
    ...
    new_book6->next = NULL;
    strcpy(new_book6->name, "Time Machine");
    strcpy(new_book6->author, " H.G. Wells");
    new_book6->id = 106;
    ptr->next = new_book6;
